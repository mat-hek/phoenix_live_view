...
export interface LiveSocketOptions {
   ...
   *
   * When set, the LiveSocket:
   * - only joins roots matching the selector,
   * - never treats the document body as a dead main view,
   * - ignores events belonging to other LiveSockets' views,
